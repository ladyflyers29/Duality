...
public class PostProcessController : MonoBehaviour {
    ...
    void Awake() {
        ...
        ChangeDaWorld.OnWorldSwitch += OnWorldSwitch;
    }
    ...
    void OnWorldSwitch() {
        if (ChangeDaWorld.isDarkWorld) {
            postProcessVolume.profile = darkWorldProfile;
        }
        else {
            postProcessVolume.profile = lightWorldProfile;
        }
    }
